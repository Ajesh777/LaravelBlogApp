...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
    <a class="navbar-brand" href="{{ url('/')}}"><h6><i class="fa fa-2x fa-feather-alt"></i> {{config('app.name', 'LsApp')}}<h6></a>
        ...
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown01">
                    ...
                    <a class="dropdown-item" href="#">Programing, SEO</a>
                    <a class="dropdown-item" href="#">Web Hosting, Web Maintenace</a>
                </div>
            </li>
            <li class="nav-item">
